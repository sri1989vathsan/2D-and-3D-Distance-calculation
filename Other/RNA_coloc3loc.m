function RNA_coloc3loc(mask1, mask2, mrnafile , pixelsize, radius, dist, alchk,reference)
% Per RNA 3 color distances and spot calculation
...
if(a>0)
    ...
    mrna5_3Data1(find(mrna5_3Data1(:,7)>300),:) = [];
%     mrna53 = num2cell(mrna5_3Data1);
...
csvwrite('Cytoplasmic Spots.csv',mrna_spots_cyt);
else
...
csvwrite('Nuclear Spots.csv',mrna_spots_nuc);
