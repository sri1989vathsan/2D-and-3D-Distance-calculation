function RNA_coloc3_intron(mask1, mask2, mrnafile , pixelsize, radius, dist, alchk,reference)
...
if(a>0)
    ...
    mrna5_3Data1 = num2cell(mrna5_3Data1);
...
cell2csv('Distances.csv',mrna5_3Data1);    
end
